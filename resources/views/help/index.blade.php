...
@section('help:content')
    <p class="warning">Il n'existe pas de mode «&nbsp;formation/training&nbsp;» dans l'application
        permettant de
        faire des «&nbsp;tests&nbsp;» qui ne seront pas enregistrés. Également, il n'est
        généralement pas
        possible d'annuler une action une fois qu'elle a été enregistrée.</p>
    ...
    <p>À l'écran d'accueil, appuyer sur «&nbsp;Ouvrir la caisse&nbsp;». Vous verrez l'écran suivant
        :</p>
    <p class="info">Si le bouton «&nbsp;Ouvrir la caisse&nbsp;» n'apparaît pas sur l'écran
        d'accueil(mais que
        vous voyez «&nbsp;Fermer la caisse&nbsp;»), la caisse est déjà ouverte.</p>
    <p class="image">[img: écran ouverture de caisse]</p>
    <ul>
        <li><strong>«&nbsp;Votre nom&nbsp;»</strong>: écrire le nom de l'aubergiste de la journée.
            Cette
            information est utilisée seulement pour avoir une idée de qui était l'aubergiste cette
            journée-là; ce n'est pas grave si un autre employé cré une fiche dans la journée, si
    ...
    <p>Appuyer sur «&nbsp;Ouvrir la caisse&nbsp;». Vous serez redirigé à l'écran d'accueil, mais les
        boutons
    ...
    <p class="info">On fait une seule fiche par «&nbsp;groupe&nbsp;» de clients. Par exemple, faire
        une seule
    ...
    <p>Sur l'écran d'accueil, appuyer sur «&nbsp;Nouvelle fiche&nbsp;». L'écran suivant
        apparaîtra:</p>
    ...
    <p>À droite, appuyer sur le ou les produits à ajouter. Les boutons bleus sont des produits, les
        boutons jaune-orange sont des catégories (appuyer dessus affiche d'autres produits). Le
        bouton vert est pour ajouter un produit spécial. Voir la section dans «&nbsp;Cas
        particuliers&nbsp;»
        pour ce bouton.</p>
    <p>Quand un produit est ajouté, il apparaît dans la partie gauche où l'on peut changer sa
        quantité (vous pouvez soit appuyer sur «&nbsp;+&nbsp;» et «&nbsp;-» pour changer sa quantité
        ou appuyer sur
        le chiffre pour faire apparaître un clavier numérique).</p>
    <p class="info">Pour supprimer un produit rajouté par erreur, faites le glisser vers la gauche
        et
        un bouton «&nbsp;Retirer&nbsp;» apparaîtra. Notez qu'une fois la fiche enregistrée, il n'est
        plus
        possible de supprimer un produit, il pourra seulement être remboursé. Voir la section des
        remboursements.</p>
    <p class="info">Il n'y a, ici, aucune différence entre «&nbsp;2 personnes en dortoir/1 nuit&nbsp;»
        et «&nbsp;1
        personne en dortoir/2 nuits&nbsp;» (donc un total de 2 dortoirs dans les deux cas). Dans les
        deux
        cas, vous appuierez une fois sur «&nbsp;Dortoir&nbsp;» et vous lui mettrez une quantité de
        2. Nous
        noterons plus tard les chambres et le nombre de personnes par chambre .</p>
    ...
    <p>Voici un exemple où deux dortoirs prix <em>non membre</em>, un dortoir <em>membre</em> et une
        carte de membre ont été achetés.</p>
    <p class="image">[img:2 dortoirs non membre, 1 dortoir membre, carte de membre]</p>
    <h4>2) Saisir les informations du client</h4>
    <p>Si les informations du client n'ont pas encore été saisies, un bouton vert «&nbsp;Informations
        du
        client&nbsp;» apparaît dans le bas de la fiche. Si les informations client ont déjà été
        saisies,
        appuyez sur «&nbsp;Modifier informations client&nbsp;» dans le haut de la fiche.</p>
    ...
    <ul>
        <li><strong>Date d'arrivée et de départ</strong>: Appuyer dans ces champs pour modifier la
            ...
            continues (ex.: le client vient ce lundi et ce jeudi). Dans ce cas, il faudra faire deux
            fiches.
        </li>
        <li><strong>Liste des chambres et nombre de personnes</strong> Sélectionnez la chambre où
            ...
            information seulement, ça n'a aucun impact sur le prix. Si plus d'une chambre est
            utilisée, appuyez sur «&nbsp;Ajouter une chambre&nbsp;».
        </li>
        <li><strong>Nom du client</strong> Ce champ est <strong>le seul obligatoire</strong> (bien
            qu'il est fortement recommandé de remplir les autres). Mettre le nom d'une seule
            personne. S'il s'agit d'un gros groupe, vous pouvez indiquer un nom descriptif (ex.: «
            Groupe d'impro louperivoise&nbsp;»).
        </li>
        ...
        <li><strong>Pays/province</strong> Si le client réside au Canada, sélectionnez sa province,
        ...
        <li><strong>Membre HI</strong> Si le client est membre HI, mettre ce champ à «&nbsp;Oui&nbsp;»
            et
        ...
        <li><strong>Numéro de passeport/# membre HI</strong> Si le client est membre HI, y indiquer
            ...
            vous avez des doutes, vous pouvez demander une carte d'identité).
        </li>
    </ul>
    <p>Appuyer sur «&nbsp;Enregistrer&nbsp;» pour enregistrer et fermer cette fenêtre. Un résumé des
        ...
        informations à tout moment en appuyant sur le bouton «&nbsp;Modifier informations client&nbsp;». </p>
    <h4>3) Enregistrer le dépôt d'une réservation effectuée en ligne (ex.: Hostelworld)</h4>
    <p class="info">Il n'y a aucun dépôt si la réservation a été effectuée par téléphone ou en
    ...
    <p>Certains sites de réservation (ex: Hostelworld, mais pas Booking.com) chargent un dépôt au
        ...
        devra être soustrait du montant à payer. </p>
    <p class="warning">La fonctionnalité de crédit (dépôt) ne doit être utilisée que pour des
        dépôts.
        Ne jamais utiliser cette fonctionnalité pour faire des remboursements, pour corriger une
    ...
    <ul>
        <li><strong>Description</strong>: s'il s'agit du dépôt d'une réservation en ligne, inscrire
    ...
    <p>Appuyée sur «&nbsp;Enregistrer&nbsp;», cette fenêtre se fermera et le dépôt sera ajouté à la
        fiche.</p>
    <p>Pour modifier un crédit, appuyer dessus. Pour le supprimer, le glisser vers la gauche et un
        bouton «&nbsp;supprimer&nbsp;» apparaîtra.</p>
    ...
    <p>Après que le client a payé (soit en argent ou par carte de crédit ou débit), il faut
        enregistrer son paiement dans l'application. Appuyez sur le bouton «&nbsp;Enregistrer le
        paiement
        &nbsp;» dans le bas de l'écran. La fenêtre suivante apparaîtra.</p>
    <p class="image">[img: modal ajouter paiement]</p>
    <p class="info">Le bouton «&nbsp;Enregistrer le paiement&nbsp;» apparaît seulement si les
        informations du
        client ont été saisies, sinon c'est le bouton «&nbsp;Informations client&nbsp;» qui apparaît
        à la
        place. Dans ce cas, commencez par saisir les informations du client.</p>
    <ul>
        ...
        <li><strong>Montant</strong>: Le montant du paiement. Par défaut, le montant total est
            indiqué, mais vous pouvez modifier ce montant (pour séparer le montant en 2, par
            exemple). Voir la note ci-dessous.
        </li>
    </ul>
    <p>Appuyez sur «&nbsp;Enregistrer&nbsp;» pour enregistrer le paiement. La fenêtre se fermera et
        le
        paiement est ajouté à la fiche.</p>
    <p>Tant que la fiche n'est pas enregistrée, vous pouvez modifier un montant en appuyant dessus,
        et vous pouvez le supprimer en le glissant vers la gauche (un bouton «&nbsp;Supprimer&nbsp;»
        apparaîtra). Mais une fois la fiche enregistrée, il ne sera plus possible de modifier ou de
        supprimer un paiement. </p>
    <p class="info">Il est possible d'enregistrer plus d'un paiement pour une fiche. Exemples:
        chaque
        membre d'un groupe paie son lit; ou un couple souhaite chacun payer la moitié d'une chambre
        privée. Dans ce cas, dans la fenêtre permettant d'enregistrer le paiement, modifiez la
    ...
    <p class="info">Il est possible d'enregistrer une fiche même si elle n'a pas encore été
        totalement
        payée. Le paiement manquant pourra être rajouté plus tard.</p>
    <p>Pour enregistrer la fiche, appuyez sur le bouton «&nbsp;Enregistrer&nbsp;» dans le bas de
        ...
        gris, mais il est possible d'appuyer dessus (un avertissement vous demandant de confirmer
        s'affichera par contre).</p>
    ...
    <p class="info">Il est possible d'accéder à la liste des fiches même si la caisse est fermée,
        mais
    ...
    <p>À la fin de la journée (peut être après quelques jours en basse saison), l'aubergiste doit
    ...
    <p>Sur la machine de carte de crédit (le TPV), fermer le lot, prendre le reçu et remplir les
        champs suivants dans l'application :</p>
    <ul>
        <li><strong>Numéro de lot</strong> Ce numéro apparaît sur le reçu de fermeture de lot du
            TPV.
        </li>
        <li><strong>Montant du TPV</strong> Inscrivez le montant du <em>grand total</em> indiqué sur
            le reçu du TPV.
        </li>
    </ul>
    <p>Dans la caisse, compter le nombre de chaque pièce et de chaque billet et remplir les champs
        de l'écran. Ne <strong>pas</strong> soustraire le montant de 100 $ qui devra rester dans la
        caisse (le fond de caisse), compter <strong>tous</strong> les billets et toutes les pièces.
    </p>
    <p>Recompter une deuxième et troisième fois si nécessaire. Faites un effort honnête pour limiter
        les erreurs !</p>
    ...
    <ul>
        ...
        <li>Faites payer le client et enregistrez le paiement[lien].</li>
        <li>Enregistrez la fiche.</li>
    </ul>
    <p class="info">Si le client souhaite rester une autre nuit, n'oubliez pas de modifier la date
        de
        départ de la fiche. Dans l'écran de la fiche, appuyez sur le bouton «&nbsp;Modifier les
    ...
    <ul>
        ...
        <li>Appuyez sur «&nbsp;Modifier les informations&nbsp;» (en haut de la fiche, sous le nom du
            client).
        </li>
    ...
    <ul>
        ...
        <li>Appuyez «&nbsp;Enregistrer&nbsp;» et la fenêtre se fermera. Le remboursement sera ajouté
            à la
            liste des items (avec une quantité négative).
        </li>
        <li><strong>Important :</strong> rajoutez une note explicative à la fiche en appuyant sur le
            bouton «&nbsp;Notes&nbsp;» en haut à droite de la fiche. Indiquez pourquoi un
            remboursement a été
            accordé au client.
        </li>
    </ul>
    <ul>
        <li>Si vous devez rembourser de l'argent au client, le montant à rembourser apparaîtra en
            jaune dans le bas de l'écran.
        </li>
        <li>Remboursez le client (dans la «&nbsp;vraie&nbsp;» vie !) avec la même méthode qu'il a
            initialement
            utilisée pour payer (en argent, sur la même carte de débit, de crédit, etc.).
        </li>
        <li>Appuyez sur «&nbsp;Enregistrer le remboursement&nbsp;». Assurez-vous de bien
    ...
    <p class="warning">Toujours rembourser le client sur <strong>la même carte</strong> que celui-ci
        a
        utilisée s'il a payé par carte. Toujours rembourser en argent si celui-ci a payé en argent.
    </p>
    <h2>Enregistrer le dépôt d'une réservation faite en ligne</h2>
    <p>Voyez les instructions dans «&nbsp;créer une nouvelle fiche&nbsp;».[lien]</p>
    <h2>Un client souhaite payer en 2 paiements (ou plus). Par exemple, un couple souhaite chacun
    ...
    <ul>
        ...
        <li>Appuyez sur le bouton «&nbsp;Notes&nbsp;» en haut à droite pour y rajouter un
            commentaire
            expliquant la situation (par exemple: «&nbsp;Nuit gratuite car employée de l'auberge HI
            Québec&nbsp;»).
        </li>
    </ul>
    <h2>Prix spéciaux (ex.: prix de groupe, prix spécial pour un événement ou un client, etc.) </h2>
    <p class="info">S'il s'agit d'un groupe, voyez aussi «&nbsp;Une fiche avec plusieurs chambres&nbsp;»
        [lien]
        .</p>
    <ul>
        ...
        <li>Dans la fenêtre qui apparaît, saisissez le nom du produit (ex.: «&nbsp;Dortoir groupe
            hockey
            &nbsp;») et indiquez le prix <strong>unitaire</strong> (ex.: pour un seul lit, une seule
            nuit,
        ...
        <li>Modifiez la quantité (par exemple, pour 3 lits en dortoirs à prix spécial, pour deux
            nuits, mettre la quantité «&nbsp;6&nbsp;»).
        </li>
    </ul>
    <p class="warning">Le nom et le prix d'un item spécial ne peuvent plus être modifiés après que
        la
        fiche est enregistrée. Si vous avez fait une erreur de prix et que vous avez enregistré la
        fiche, voir la section «&nbsp;J'ai mis le mauvais prix d'un produit spécial&nbsp;». </p>
    <p class="info">Si le total est payé en différents paiements (par exemple, chaque membre du
        groupe
        paie séparément son lit), voir la note dans «&nbsp;Faire payer le client et enregistrer le
        paiement&nbsp;» pour enregistrer les paiements individuellement[lien].</p>
    <p class="info">Cette fiche peut aussi contenir des items à prix réguliers. Il est fréquent
        qu'un
    ...
    <p class="info">La caisse doit être ouverte pour pouvoir enregistrer une sortie ou un ajout
        d'argent.</p>
    <p>Vous devez enregistrer tout argent sonnant (billet, monnaie) qui est ajouté ou retiré de la
    ...
    <ul>
        ...
        <li>Dans la fenêtre qui s'ouvre, indiquer le type (sortie ou entrée d'argent selon que de
            l'argent a été retiré ou ajouté), le montant exact et une description (ex.: «&nbsp;Épicerie
            &nbsp;», «&nbsp;Ajout de monnaie&nbsp;»).
        </li>
    </ul>
    <p>Vous pouvez modifier une entrée en appuyant dessus.</p>
    <p>Vous pouvez supprimer une entrée en la glissant vers la gauche et en appuyant sur «&nbsp;Supprimer
        &nbsp;». </p>
    <hr>
    ...
    <p>Si vous n'êtes pas dans une de ces situations, commencez par quitter l'application (appuyer
        sur le bouton «&nbsp;retour&nbsp;» de la tablette. Pas le bouton principal, celui avec la
        flèche).
        Ouvrez à nouveau la tablette.</p>
    ...
    <ul>
        <li>Connectez-vous, depuis n'importe quel ordinateur ou avec le navigateur web de la
            tablette, à l'outil de gestion à <a href="https://venteshirdl.ca" target=_blank>https://venteshirdl.ca</a>
            à l'aide des informations de connexion (voir cahier des codes «&nbsp;Guide d'utilisation
            des
            systèmes de réservation&nbsp;» ou ailleurs).
        </li>
        ...
        <li>Un code à quatre chiffres apparaîtra. Inscrire ce code dans le champ «&nbsp;Code&nbsp;»
            de l'écran
            d'authentification de la tablette.
        </li>
    </ul>
    <p class="info">Le code doit être saisi dans les minutes suivant son affichage, sinon un nouveau
        code devra être généré.</p>
    <p class="info">La tablette reprendra là où elle était. Si le code a été saisi sur une nouvelle
        ...
        <li>Si l'application n'est pas déjà installée sur la nouvelle tablette, suivre les
            ...
            <ul>
                <li>Permettez à la tablette d'installer des applications de sources inconnues
                    (recherchez sur Google «&nbsp;android autoriser sources inconnues&nbsp;»)
                </li>
                <li>Depuis le navigateur web de <strong>la tablette</strong>, visitez <a
                            href="https://venteshirdl.com/app.apk">https://venteshirdl.com/app
                        .apk</a>. Ceci va télécharger l'application sur la tablette.
                </li>
                ...
                <li>Il est également recommandé de faire un lien vers cette documentation sur le
                    bureau de la tablette.
                </li>
            </ul>
        <li>Si vous ouvrez l'application, elle devrait vous demander un code d'autorisation. Suivez
            les instructions pour en générer un nouveau[lien].
        </li>
    </ul>
    <h2>La tablette est volée ou perdue de façon permanente</h2>
    <p>Suivez les instructions pour générer un nouveau code[lien]. Ceci a pour effet de déconnecter
        les tablettes qui seraient encore connectées.</p>
    <h1>FAQ</h1>
    <h2>Le client souhaite payer plus tard</h2>
    <p>Il est possible d'enregistrer une fiche sans avoir saisi tous les paiements. L'écran listant
        les fiches[lien] montre également quelles fiches n'ont pas encore été payées en totalité.
        Par contre, évitez le plus possible cette situation.</p>
    <h2>Doit-on fermer la caisse tous les jours ?</h2>
    <p>Oui, sauf en basse saison. Vérifiez avec le directeur de l'auberge.</p>
    <h2>Un ancien client revient, est-ce que je dois refaire une nouvelle fiche ?</h2>
    <p>Oui, car il n'est pas possible d'avoir une fiche pour des journées non contigües. Il n'est
        malheureusement pas possible «&nbsp;d'importer&nbsp;» les informations du client depuis une
        ancienne
        fiche, elles doivent être saisies de nouveau (comme si c'était un nouveau client).</p>
    <h2>Le client souhaite avoir un reçu</h2>
    <p>L'application ne permet malheureusement pas d'imprimer ou d'envoyer des reçus par courriel.
        Utilisez un carnet de reçu.</p>
    <ul>
        ...
        <li>Sur la tablette, dans la fiche du client, se trouve à côté du montant total (en bas de
            la fiche) un bouton «&nbsp;Détails&nbsp;». Appuyez dessus pour faire afficher le détail
            des taxes.
        </li>
    ...
    <p>Si la fiche a déjà été enregistrée, il n'est pas possible de modifier un item existant. Vous
        devez rembourser l'item incorrect[lien] pour ensuite, rajouter le nouvel item[lien]. </p>
    <p>Si le client doit être remboursé, effectuez le remboursement[lien]. Notez que si la fiche n'a
        pas encore été enregistrée depuis le paiement, il peut être possible de simplement le
        supprimer[lien].</p>
    ...
    <p>Si la fiche a déjà été enregistrée, il n'est pas possible de modifier la quantité d'un item
        déjà vendu. Vous devrez soit rembourser la quantité en trop (remboursement partiel) [lien]
        ou rajouter à nouveau le produit pour augmenter la quantité. </p>
    ...
    <p>Si la fiche a déjà été enregistrée, vous pourrez seulement rembourser l'item (et pas le
        supprimer)[lien]</p>
    ...
    <p>Si la fiche n'a pas encore été enregistrée, appuyez sur l'item du produit spécial. Une
        fenêtre apparaîtra vous permettant de modifier le prix du produit spécial.</p>
    <p>Si la fiche a été enregistrée, vous devrez premièrement rembourser l'item[lien] et ensuite le
        rajouter avec les bonnes informations[lien].
    <h3>J'ai indiqué le mauvais mode de paiement (ex.: «&nbsp;par carte&nbsp;» au lieu de «&nbsp;en
        argent&nbsp;») ou
        j'ai mis le mauvais montant.</h3>
