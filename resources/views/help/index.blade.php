...
@section('help:content')
    ...
    <hr>
    <h1><a name="open-register"></a>Ouvrir la caisse</h1>
    ...
    <hr>
    <h1><a name="new-order"></a>Nouvelle inscription/fiche («&nbsp;check-in&nbsp;» d'un client)</h1>
    ...
    <hr>
    <h1><a name="view-orders"></a>Voir les fiches/retrouver une fiche</h1>
    ...
    <hr>
    <h1><a name="close-register"></a>Fermer la caisse</h1>
    ...
    <p>Suivez les instructions de
        <a href="#add-product-to-existing-order">«&nbsp;Rajouter un produit à une fiche
            existante&nbsp;»</a>.</p>
    <h2><a name="add-product-to-existing-order"></a>Rajouter un produit à une fiche existante</h2>
    ...
    <h2><a name="edit-rooms"></a>Modifier le numéro de chambre/les chambres utilisées/le nombre de
            personnes</h2>
    <ol>
        <li>Depuis l'accueil, appuyez sur «&nbsp;Voir les fiches&nbsp;» et appuyez sur la fiche
            souhaitée.
    ...
    <h2><a name="refund-item"></a>Rembourser un item</h2>
    ...
    <h2><a name="special-item"></a>Prix spéciaux (ex.: prix de groupe, prix spécial pour un événement ou
            un client, etc.)
    </h2>
    ...
    <h2><a name="cash-movement"></a>Enregistrer une sortie ou entrée d'argent (ex.: pour faire un
        achat en argent)</h2>
    ...
    <hr>
    <h1>FAQ</h1>
    <h2>Est-ce qu'un client peut payer plus tard ?</h2>
    ...
    <h2>Le client souhaite avoir un reçu, comment faire ?</h2>
    ...
    <p>Si la fiche a déjà été enregistrée, vous pourrez seulement <a href="#refund-item">rembourser
        l'item</a></p>
    <h3><a name="error-special-item"></a>J'ai mis le mauvais nom/prix à un produit spécial</h3>
    ...
    <hr>
    <h1>Code d'autorisation et nouvelle tablette</h1>
    ...
    <h2><a name="autorize"></a>Saisir un nouveau code d'autorisation</h2>
