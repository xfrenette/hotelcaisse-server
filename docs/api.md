...
* `currentRegister.number` (integer) Generated number for this register
...
* `createdAt`: (optional, timestamp) Timestamp when the CashMovement was created
...
* `createdAt`: (timestamp, optional) Timestamp of the creation date
