...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('BACKUP_NAME', 'venteshirdl.com'),
        ...
        'destination' => [
             ...
             */
            'disks' => [
                env('BACKUP_DISK_1', 'local'),
                env('BACKUP_DISK_2', 'local'),
            ],
        ],
    ],
    ...
    'monitorBackups' => [
        [
            'name' => env('BACKUP_NAME', 'venteshirdl.com'),
            'disks' => [env('BACKUP_DISK_1'), env('BACKUP_DISK_2')],
    ...
    'notifications' => [
         ...
         */
        'mail' => [
            'from' => env('BACKUP_EMAIL_FROM', 'info@aubergerdl.ca'),
            'to' => env('BACKUP_EMAIL_TO', 'info@aubergerdl.ca'),
        ],
